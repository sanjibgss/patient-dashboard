   ...
   public function all(): Collection
   {
...

    {
        ...
        foreach($getDivision as $division){
            $rand= rand(0,9);
            $getPatients = HospitalPatientDetails::where('division_id',"=", $division['id'])->count();
            $output[] = array(
...

    {
        ...
        foreach($getDivision as $division){
            $rand= rand(0,9);
            $getPatients = HospitalDivision::join('hospital_patient_details','hospital_patient_details.division_id',"=",'hospital_divisions.id')
